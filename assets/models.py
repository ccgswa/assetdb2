...
class Asset(models.Model):
    ...
    location = models.CharField(max_length=200, choices=LOCATION_CHOICES, default='ccgs')
    exact_location = models.CharField('Legacy location', db_index=True, max_length=200, blank=True)
